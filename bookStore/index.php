<?php
  ...
  if(array_key_exists("logout", $_GET)) {
      ...
      unset($_SESSION['Employee_in']);
      unset($_SESSION['Admin_in']);
      setcookie('StayLoggedIn', "", time() - 60*60);
      $_COOKIE['userLogIn'] = "";
  } else if((array_key_exists("StayLoggedIn", $_COOKIE)) || (array_key_exists("StayLoggedIn", $_SESSION))){
        ...
        <div class="header-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h5>LOGIN TO OUR SITE TO EXPLORE AND ORDER BOOKS</h5></div>
                    <div class="col-md-3">
    ...
    <section class="recent-book-sec">
        <div class="container">
            ...
            <div class="row">
              <?php
              include("connection.php");
              $query2 = "SELECT * FROM Books ORDER BY RAND() LIMIT 5";
